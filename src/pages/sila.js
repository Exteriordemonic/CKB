      ...
      <Layout supernav={this.props.supernav}>
        ...
        <Content img={imageTwo} style={{ marginBottom: '100px' }}>
          ...
          <p className="text">
            ...
            atrybutów fizycznych. Kształtujemy ją jako umiejętność traktując
            trening jako doskonalenie, a nie powtarzanie ruchów w celu zmęczenia
            ciała tzw. “zajazdu”. Praktyka nie „workout” jest kluczem do
            systematycznego kształtowania każdej umiejętności.
          </p>
          <p className="text">
            StrongFirst kładzie nacisk na doskonałość techniczną vs.
            intensywność, ale do chwili kiedy technika jest doskonała.
            “Ćwiczenia, programy, plany treningowe- to wszystko rzeczy o
            niewielkim znaczeniu, jeżeli technika nie jest perfekcyjna”- były
            senior instruktor Rob Lawrence.
          </p>
        </Content>
      </Layout>
    )
